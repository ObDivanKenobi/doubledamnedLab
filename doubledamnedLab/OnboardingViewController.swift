...
class OnboardingController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        closeButton.addTarget(self, action: #selector(OnboardingController.pressed(_:)), for: .touchUpInside)
        view.addSubview(closeButton)
    }
    
    func pressed(_ sender: Any?) {
        let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "MainVC") as! FullCollectionViewController
